...
uilabel(fig,'Text','ck value:', 'Position',[340 75+baseShift 60 20]);
edit_ckValue = uieditfield(fig,'numeric','Position',[340 75+baseShift 50 22],'Value',+1);

uilabel(fig,'Text','ck flag:', 'Position',[340 50+baseShift 60 20]);
edit_ck = uieditfield(fig,'numeric','Position',[340 50+baseShift 50 22],'Value',0);
